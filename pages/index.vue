<template>
  ...
  <div class="flex flex-wrap gap-6">
    <a 
      ...
      class="group relative flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-primary to-primary-dark dark:from-primary-dark dark:to-primary overflow-hidden transition-all duration-100 hover:scale-110"
    >
      <FontAwesomeIcon :icon="platform.icon" class="text-2xl text-white"></FontAwesomeIcon>
      <span class="absolute bottom-0 left-0 right-0 py-1 px-1 text-xs text-black dark:text-white bg-white/50 dark:bg-black/50 backdrop-blur-sm transform translate-y-full group-hover:translate-y-0 transition-transform duration-100 text-center">
        {{ platform.name }}
      </span>
    </a>
  </div>
